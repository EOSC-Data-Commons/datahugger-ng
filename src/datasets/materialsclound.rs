...
// API root url at https://archive.materialscloud.org/api/
//
// MaterialsCloud use invenioRDM same as what used by zenodo use flatten folder tree structure, all files with nexted parent folder are list in one
// API call.
#[derive(Debug)]
pub struct MaterialsCloud {
    pub id: String,
}
